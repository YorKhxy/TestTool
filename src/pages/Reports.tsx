  ...
  return (
    <div className="grid gap-4">
      ...
      <div className="grid gap-4 lg:grid-cols-[320px_1fr]">
        <div className="rounded-xl border-2 border-zinc-600 bg-zinc-900">
          <div className="border-b border-zinc-600 px-4 py-3 text-xs font-medium text-zinc-300 bg-zinc-800/50">历史（最多100条）</div>
              ...
              <div className="p-2">
                {list.map((it) => (
                  <button
                    key={it.runId}
                    className={cn(
                      'w-full rounded-lg px-3 py-2 text-left text-sm text-zinc-200 transition hover:bg-zinc-700/40',
                      it.runId === active && 'bg-zinc-700/60',
                    )}
        ...
        <div className="min-w-0 rounded-xl border-2 border-zinc-600 bg-zinc-900">
          {report ? (
            <div className="p-4">
              <div className="flex items-center justify-between">
                ...
                <button
                  className="inline-flex items-center gap-2 rounded-lg border border-zinc-600 bg-zinc-800 px-3 py-2 text-sm text-zinc-200 transition hover:bg-zinc-700"
              ...
              <div className="mt-4 max-h-[520px] overflow-auto rounded-lg border border-zinc-600">
